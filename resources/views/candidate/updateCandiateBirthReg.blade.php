            ...
            <div class="col-12">
                <div class="card rounded-0 border-0 mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="card-title text-uppercase">Update Candidate Birth Registration Number </h5>
                            </div>
                        </div>
                    </div>
                    {!! Form::open(['url' =>'updateCandidateBirthRegNumber','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group float-label">
                                    <input type="text" class="form-control active" name="birth_reg_no" placeholder="Birth Registartion" required="" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 w-100">
                                <label class="text-secondary">Finger Print </label>
                            </div>
                            <div class="col-12">
                                <div class="form-group float-label">
                                    <input type="text" class="form-control active" name="finger_print" placeholder="Finger Print">
                                </div>
                            </div>
                        </div>
