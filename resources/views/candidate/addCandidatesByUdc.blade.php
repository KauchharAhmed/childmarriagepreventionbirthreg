            ...
            <div class="col-12">
                <div class="card rounded-0 border-0 mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="card-title text-uppercase">Add New Canidates</h5>
                            </div>
                        </div>
                    </div>
                    {!! Form::open(['url' =>'insertCandidateInfoByUDC','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                    <div class="card-body">
                                ...
                                <div class="form-group float-label" >
                                    <select class="form-control" name="institute_id">
                                      ...
                                      <?php foreach ($all_institute as $value2) { ?>
                                          <option  value="<?php echo $value2->id ; ?>"><?php echo $value2->institute_name ; ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group float-label">
                                    <input type="text" class="form-control active" name="birth_reg_no" placeholder="Birth Registration" required="">
                                </div>
                            </div>
                        </div>
