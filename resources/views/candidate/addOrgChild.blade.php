        ...
        <div class="row">
            <div class="col-12">
                <div class="card rounded-0 border-0 mb-3">
                    ...
                    {!! Form::open(['url' =>'insertChildInfoByOrganization','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group float-label">
                                    <input type="text" class="form-control active" name="name" placeholder="Student Name" required="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 w-100">
                                <label class="text-secondary">Date Of Birth (d-m-Y)<span style="color: red;">*</span></label>
                            </div>
                            <div class="col-12">
                                <div class="form-group float-label">
                        ...
                        <div class="row">
                            <div class="col-12 w-100">
                                <label class="text-secondary">Father Nid No </label>
                            </div>
                            <div class="col-12">
                                <div class="form-group float-label">
                                    <input type="text" class="form-control active" name="father_nid_no" placeholder="Father Nid No">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 w-100">
                                <label class="text-secondary">Mother Nid No </label>
                            </div>
                            <div class="col-12">
                                <div class="form-group float-label">
                                    <input type="text" class="form-control active" name="mother_nid_no" placeholder="Mother Nid No">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 w-100">
                                <label class="text-secondary">Guardian Nid No </label>
                            </div>
                            <div class="col-12">
                                <div class="form-group float-label">
                                    <input type="text" class="form-control active" name="guardian_nid_no" placeholder="Guardian Nid No">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group float-label">
                                   <input type="text" class="form-control active" name="address" placeholder="Village" required="">
                                </div>
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="type_here" value="2">
