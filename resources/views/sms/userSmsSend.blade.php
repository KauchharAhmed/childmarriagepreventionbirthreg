                        ...
                        <div class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                <?php $j = 1 ; foreach ($result as $value) { ?>
                                    <tr>
                                        <td><input type="checkbox" name="member_id[]" value="<?php echo $value->id.'.'.$value->mobile; ?>"></td>
                                        <td><?php echo $value->name; ?></td>
                                        <td><?php echo $value->designation ; ?></td>
                                        <td><?php echo $value->mobile ; ?></td>
                                        <td><img src="{{URL::to('')}}/<?php echo $value->image ; ?>" alt="" style="width: 50px;height:50px;"></td>
                                        <td>
                                            <?php if($value->type == 1){echo "Admin"; }elseif($value->type == 2){echo "Mentor"; }elseif($value->type == 3){echo $value->institute_name ;}elseif($value->type == 4){echo $value->organization_name ; }elseif($value->type == 5){echo "Marriage Register" ; }elseif($value->type == 6){echo $value->union_name; } ?>
                                        </td>
