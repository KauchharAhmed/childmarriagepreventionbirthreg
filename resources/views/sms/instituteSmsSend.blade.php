            ...
            <div class="col-12">
                <div class="card rounded-0 border-0 mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="card-title text-uppercase">Send SMS Institute</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                <?php $j = 1 ; foreach ($result as $value) { ?>
                                    <tr>
                                        <td><input type="checkbox" name="member_id[]" value="<?php echo $value->id.'.'.$value->institute_contact_number; ?>"></td>
                                        <td><?php echo $value->institute_name; ?></td>
                                        <td><?php echo $value->institute_contact_number ; ?></td>
...
<script>
    $('body').on('click',"#send_sms",function(e){
        ...
        $.ajax({
            'url':"{{ url('/sendSMSbyAdminInstitute') }}",
            'type':'post',
            'dataType':'text',
            data:{  
                selected:selected,
