...
<head>
    ...
    <title>Chiled Marriage Protect System</title>
</head>
    ...
    <div class="wrapper">
        ...
        <div class="page">
            <div class="page-content h-100">
                <div class="background theme-header"></div>
                <div class="row mx-0  justify-content-center">
                    <div class="col-10 col-md-6 col-lg-4 my-3 mx-auto text-center align-self-center">
                        ...
                        <br>
                        <h5 class="text-white mb-4">Login</h5>
                        @if (count($errors) > 0)
                        ...
                        {!! Form::open(['url' =>'adminLogin','method' => 'post','role' => 'form','class'=>'form-horizontal']) !!}
                        <div class="login-input-content ">
                            <div class="form-group">
                                <input type="text" class="form-control rounded text-center" name="mobile" placeholder="Login mobile" required="">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control rounded text-center" name="password" placeholder="Password" required="">
                            </div>

                            <button type="submit" class="btn btn-block btn-success rounded border-0 z-3">Log in</button>
                            {!! Form::close() !!}
                        </div>
                        <br>
                        <center><a href="{{ URL::to('signUp') }}" class="btn btn-block btn-info rounded border-0 z-3">Sign Up </a></center>
                        <br>
                        <br>
                            <center><a href="{{ URL::to('public/apps/child.apk') }}" class="btn btn-block btn-danger rounded border-0 z-3" style="display: none;">Download Apps </a></center>
                    </div>
                </div>
