...
<div class="content-sticky-footer">
    <div class="content-sticky-footer pt-0">
        ...
        <div class="row mx-0 mt-3">
            <div class="col mb-2">
                <a href="{{URL::to('udcProfileInfo')}}" class="btn btn-block btn-primary rounded border-0">UPDATE PROFILE</a>
            </div>
            <div class="col">
                <a href="{{URL::to('udcChangePassword')}}" class="btn btn-block btn-outline-secondary rounded">CHANGE PASSWORD</a>
            </div>
        </div>
