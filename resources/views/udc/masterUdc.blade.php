    ...
    <div class="wrapper">
        ...
        <div class="sidebar sidebar-left">
            ...
            <nav class="navbar">
                <ul class="navbar-nav">                    
                    <li class="nav-item">
                        <a href="{{URL::to('udcDashboard')}}" class="sidebar-close">
                    ...
                    <li class="nav-item">
                        <a href="{{URL::to('addCandidatesByUdc')}}" class="sidebar-close">
                            <div class="item-title">
                                <i class="material-icons">supervisor_account</i> Add Candidate
                            </div>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{URL::to('newCandidateListByUdc')}}" class="sidebar-close">
                            <div class="item-title">
                                <i class="material-icons">assignment</i> New Candidate List
                            </div>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{URL::to('searchCandidatesByUdc')}}" class="sidebar-close">
                            <div class="item-title">
                    ...
                    <li class="nav-item">
                        <a href="{{URL::to('sendSMSByUDC')}}" class="sidebar-close">
                            <div class="item-title">
                                <i class="material-icons">mail_outline</i> Send Sms
                            </div>
                        </a>
                    </li>
        ...
        <div class="page">
            ...
            <header class="row m-0 fixed-header">
                ...
                <div class="col center">
                    <a href="{{URL::to('udcDashboard')}}" class="logo">
                        <figure><img src="{{URL::to('public/assets/img/bd_logo.png')}}" alt=""></figure></a>
                </div>
                <div class="right">
                    <a href="{{URL::to('udcProfile')}}"><i class="material-icons">person</i></a>
                </div>
            </header>
