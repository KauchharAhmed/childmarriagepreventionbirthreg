            ...
            <div class="col-12">
                <div class="card rounded-0 border-0 mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="card-title text-uppercase">Add New Kazi</h5>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-group float-label">
                                    <select class="form-control" name="union_id" id="union_id" required="">
                                      ...
                                      <?php foreach ($result as $value) { ?>
                                          <option value="<?php echo $value->id ; ?>" <?php if($value->id == $values->union_id){echo "selected";}else{echo "" ;} ?>><?php echo $value->union_name ; ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group float-label" >
                                    <select class="form-control spinner" name="ward_id" id="ward_id" >
                                        <?php foreach ($all_ward as $ward_value) { ?>
                                            <option value="<?php $ward_value->id ?>" <?php if($ward_value->id == $values->ward_id){echo "selected";}else{echo "" ;} ?>><?php echo $ward_value->ward_name; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
