    ...
    <div class="wrapper">
        ...
        <div class="sidebar sidebar-left">
            ...
            <nav class="navbar">
                <ul class="navbar-nav">                    
                    <li class="nav-item">
                        <a href="{{URL::to('kaziDashboard')}}" class="sidebar-close">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{URL::to('searchCandidates')}}" class="sidebar-close  dropdown-item">
                            Age Check
                            </a>

                            <a href="{{URL::to('manageCandidatesByKazi')}}" class="sidebar-close  dropdown-item">
                                All Candidates
                            </a>
                        </div>
                    </li>
        ...
        <div class="page">
            ...
            <header class="row m-0 fixed-header">
                ...
                <div class="col center">
                    <a href="{{URL::to('kaziDashboard')}}" class="logo">
                        <figure><img src="{{URL::to('public/assets/img/bd_logo.png')}}" alt=""></figure></a>
                </div>
                <div class="right">
                    <a href="{{URL::to('kaziProfile')}}"><i class="material-icons">person</i></a>
                </div>
            </header>
