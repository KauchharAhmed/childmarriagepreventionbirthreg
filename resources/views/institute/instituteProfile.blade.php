...
<div class="content-sticky-footer">
    <div class="content-sticky-footer pt-0">
                ...
                <a href="#" class="media">
                    ...
                    <div class="media-body align-self-center ">
                        ...
                        <p class="text-white">
                            ...
                            <br> <?php if($value->type == 3){echo $value->institute_name;}elseif($value->type == 4){echo $value->organization_name;}  ?>
        ...
        <div class="row mx-0 mt-3">
            <div class="col mb-2">
                <a href="{{URL::to('instituteProfileInfo')}}/<?php echo $value->id ; ?>" class="btn btn-block btn-primary rounded border-0">UPDATE PROFILE</a>
            </div>
            <div class="col">
                <a href="{{URL::to('instituteChangePassword')}}" class="btn btn-block btn-outline-secondary rounded">CHANGE PASSWORD</a>
            </div>
        </div>
