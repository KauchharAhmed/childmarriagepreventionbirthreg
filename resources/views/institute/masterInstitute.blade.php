    ...
    <div class="wrapper">
        ...
        <div class="sidebar sidebar-left">
            ...
            <nav class="navbar">
                <ul class="navbar-nav">                    
                    <li class="nav-item">
                        <a href="{{URL::to('instituteDashboard')}}" class="sidebar-close">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{URL::to('addStudent')}}" class="sidebar-close  dropdown-item" style="display: <?php if($type == 4){echo "none";}else{echo "";} ?>">
                                Add Student
                            </a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{URL::to('manageInstituteCandidates')}}" class="sidebar-close">
                            <div class="item-title">
        ...
        <div class="page">
            ...
            <header class="row m-0 fixed-header">
                ...
                <div class="col center">
                    <a href="{{URL::to('instituteDashboard')}}" class="logo">
                        <figure><img src="{{URL::to('public/assets/img/bd_logo.png')}}" alt=""></figure></a>
                </div>
                <div class="right">
                    <a href="{{URL::to('instituteProfile')}}"><i class="material-icons">person</i></a>
                </div>
            </header>
