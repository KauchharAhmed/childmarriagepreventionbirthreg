        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center justify-content-between d-flex">
                    <a href="{{URL::to('organizationDashboard')}}" class="btn btn-danger rounded sq-btn text-white" title="Home"><i class="material-icons w-25px">home_outline</i></a>


                    <a href="{{URL::to('manageCandiatesByOrganization')}}" class="btn btn-success rounded sq-btn text-white" title="Add Member"><i class="material-icons w-25px">search</i></a>

                    <a href="{{URL::to('addOrgChild')}}" class="btn btn-warning rounded sq-btn text-white" title="Profile"><i class="material-icons w-25px">account_box</i></a>
            ...
            <div class="col-6 col-md-4 col-lg-2 pb-2">
                <div class="card">
                    <div class="card-body text-center pb-2">
                        <div class="row">
                            <div class="col pr-0 text-left">
                                <p class="text-uppercase font-weight-bold text-primary">This Month Added</p>
                            </div>
                        </div>
                        <div class="w-100">
                            <h2 class="font-weight-light mb-0"><?php echo $runing_month_count ; ?></h2>
                        </div>
                    </div>
                </div>
            </div>
