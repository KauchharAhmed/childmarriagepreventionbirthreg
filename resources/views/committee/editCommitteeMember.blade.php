            ...
            <div class="col-12">
                <div class="card rounded-0 border-0 mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="card-title text-uppercase">Edit Committee Member Information</h5>
                            </div>
                        </div>
                    </div>
                    {!! Form::open(['url' =>'updateCommitteeMemberInfo','method' => 'post','role' => 'form','class'=>'form-horizontal','files' => true]) !!}
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="union_id" required="">
                                      ...
                                      <?php foreach ($all_union as $value2) { ?>
                                          <option value="<?php echo $value2->id ; ?>" <?php if($value->union_id == $value2->id){echo "selected";}else{echo "";} ?>><?php echo $value2->union_name ; ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group float-label">
                                    <input type="text" class="form-control active" name="village" value="<?php echo $value->village ; ?>" required="">
                                </div>
                            </div>
                        </div>
