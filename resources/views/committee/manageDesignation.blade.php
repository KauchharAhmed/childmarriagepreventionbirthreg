            ...
            <div class="col-12">
                <div class="card rounded-0 border-0 mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="card-title text-uppercase">Manage Designation List</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php $j = 1 ; foreach ($result as $value) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{URL::to('changeDesignationStatus/'.$value->id)}}">
                                        ...
                                        <td>
                                            <a href="{{URL::to('editDesignation/'.$value->id)}}" title="">
