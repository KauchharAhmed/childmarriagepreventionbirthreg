            ...
            <div class="col-12">
                <div class="card rounded-0 border-0 mb-5">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="card-title text-uppercase">Manage Upazila Committee Member List</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php $j = 1 ; foreach ($result as $value) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{URL::to('changeUpazilaMemberStatus/'.$value->id)}}">
                                        ...
                                        <td>
                                            <a href="{{URL::to('editUpazilaCommitteeMember/'.$value->id)}}" title="">
